...
$("document").ready(function(){
    ...
    $(".columns-right .btn-secondary:nth-child(2)").html("<i class='fa fa-toggle-off'></i>");
    $(".columns-right .export").addClass("btn-secondary");
    $(".columns-right .keep-open").addClass("btn-secondary");
    $(".columns-right .export .btn-secondary i").removeClass("glyphicon glyphicon-export").addClass("fa fa-share-square-o");
