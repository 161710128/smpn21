<footer>
			...
			<div class="footer-top-area pt-100 pb-70 bg-opacity-5" style="background-image:url(frontend/img/bg/2.jpg)">
				<div class="container">
								...
								<div class="footer-wrapper mb-30">
									...
									<ul class="latest-news">
										<li>
											<div class="latest-news-info">
												<div class="latest-news-img">
													<a href="blog-details.html"><img src="{{ asset('frontend/img/footer/1.jpg') }}" alt="" /></a>
												</div>
										...
										<li>
											<div class="latest-news-info">
												<div class="latest-news-img">
													<a href="blog-details.html"><img src="{{ asset('frontend/img/footer/2.jpg') }}" alt="" /></a>
												</div>
												<div class="latest-news-content">
													<span>16 th Sep, 2017</span>
													<h5><a href="blog-details.html">Sports Day is near ready soon</a></h5>
			...
			<div class="footer-bottom-area bg-opacity-8 ptb-25" style="background-image:url(frontend/img/bg/18.jpg)">
				<div class="container">
					<div class="row">
						<div class="col-md-6 col-sm-6">
							<div class="copyright">
								<p><i class="fa fa-copyright"></i>Copyright, 2017 <a href="http://devitems.com/">Devitems.com</a></p>
							</div>
						</div>
						<div class="col-md-6 col-sm-6">
