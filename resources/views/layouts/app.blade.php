        ...
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <!-- <li class="nav-item">
                        <a class="nav-link" href="{{ route('eskul.index') }}">Eskul</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('kategorigaleri.index') }}">Kategori Galeri</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('kategoriartikel.index') }}">Kategori Artikel</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('kategorifasilitas.index') }}">Kategori Fasilitas</a>
                    </li>
                    <li class="nav-item">
